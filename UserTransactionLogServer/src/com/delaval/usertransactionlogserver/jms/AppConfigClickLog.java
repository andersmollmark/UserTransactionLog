...
import com.delaval.usertransactionlogserver.jms.consumer.ClickLogListener;
 ...
 */
@Configuration
public class AppConfigClickLog {
    ...
    MessageListenerAdapter receiver() {
        return new MessageListenerAdapter(new ClickLogListener()) {{
            setDefaultListenerMethod(ClickLogListener.NAME_OF_PROCESS_METHOD);
        }};
    }
    ...
    SimpleMessageListenerContainer container(final MessageListenerAdapter messageListener,
        ...
        return new SimpleMessageListenerContainer() {{
            ...
            setDestinationName(ServerProperties.getInstance().getProp(ServerProperties.PropKey.JMS_QUEUE_DEST_CLICK));
